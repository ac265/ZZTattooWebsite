     ...
     <form method="post" id="order_process_form" action="payment.php">
      <div class="row">
       <div class="col-md-8" style="border-right:1px solid #ddd;">
        <h4 align="center">Müşteri Detayları</h4>
        <div class="form-group">
         <label><b>Kart Sahibi <span class="text-danger">*</span></b></label>
           ...
           <div class="form-group">
            <label><b>Teslimat Adresi <span class="text-danger">*</span></b></label>
           ...
           <div class="row">
            <div class="col-sm-6">
             <div class="form-group">
              <label><b>Şehir <span class="text-danger">*</span></b></label>
            ...
            <div class="col-sm-6">
             <div class="form-group">
              <label><b>Posta Kodu <span class="text-danger">*</span></b></label>
           ...
           <div class="row">
            ...
            <div class="col-sm-6">
             <div class="form-group">
              <label><b>Ülke <span class="text-danger">*</span></b></label>
           ...
           <hr />
           <h4 align="center">Ödeme Detayları</h4>
           <div class="form-group">
                  <label>Kart Numarası <span class="text-danger">*</span></label>
              ...
              <div class="form-group">
                 <div class="row">
                  <div class="col-md-4">
                   <label>Bitiş Ayı<span class="text-danger">*</span></label>
                  ...
                  <div class="col-md-4">
                   <label>Bitiş Yılı<span class="text-danger">*</span></label>
        ...
        <div align="center">
         ...
         <input type="button" name="button_action" id="button_action" class="btn btn-success btn-sm" onclick="stripePay(event)" value="ÖDEMEYİ TAMAMLA" />
        </div>
        <br />
       </div>
       <div class="col-md-4">
        <h4 align="center">Sipariş Detayları</h4>
        <?php
        echo $order_details;
        ?>
       </div>
